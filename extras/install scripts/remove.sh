#!/bin/zsh --no-rcs
# -----------------------------------------------
# Clear existing Electron Blocker installations
# -----------------------------------------------


# MARK: Variables
# -----------------------------------------------
launchServicePrefix="com.khronokernel.electron-blocker"
installationDestinationCore="/Library/PrivilegedHelperTools/Electron-Blocker.app"
